...
//			Пройдемся по масиву студентов
			...
			for (Student student : set) {
				...
				bw.write(student.getFirsName()+";"+student.getLastName()+";"+student.getAge()+";"+sex+";"+student.getGpa());
				bw.newLine();
	...
	public Group load() {
		...
		try(BufferedReader br = new BufferedReader(new FileReader(file)))
		{
			...
			{
				if (i==0) grope.setGroupName(s);
				if (i==1) grope.setUniverName(s);
				if (i>1)
				{
					date = s.split(";");
					boolean sex=false;;
